            ...
            <div className="bg-orange-50 border-2 border-orange-200 rounded-3xl p-8 shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex gap-4 w-full md:w-auto">
                <Button 
                  ...
                  className="flex-1 md:flex-none px-6 py-6 rounded-xl border-2 border-orange-200 text-orange-600 font-bold hover:bg-orange-100 transition"
                >
                  Discard
                </Button>
                <Button 
                  onClick={onRestoreDraft}
                  className="flex-1 md:flex-none px-8 py-6 rounded-xl bg-orange-600 text-white font-bold shadow-lg hover:bg-orange-700 transition active:scale-95"
                >
                  Resume Draft
                </Button>
              </div>
